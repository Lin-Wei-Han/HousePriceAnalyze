...
#------------------------------
land = land_before[,-c(3,5,6,7,9,14,24,25,26,27,28,33)]
land = land[-c(1),]
#------------------------------
# rename colname
#------------------------------
names(land) <- c("localArea","tradeSign","landShiftArea","tradeDate","shiftFloor","totalFloor","type","mainUse","completeDate","totalKM",
